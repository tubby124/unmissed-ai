...
export interface ClientConfig {
  ...
  // A4 — Per-client corpus (legacy — Ultravox corpus retired)
  ...
  ultravox_corpus_source_id: string | null
  ultravox_corpus_status: string | null
  ultravox_corpus_synced_at: string | null
