...
export default function Step2Voice({ data, onUpdate }: Props) {
  ...
  // Voicemail niche always uses message_only — enforce at data level even though UI section is hidden
  useEffect(() => {
    if (data.niche === "voicemail" && data.callHandlingMode !== "message_only") {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Tap a voice to hear a sample. Pick one that matches your brand.
        </p>
      </div>
