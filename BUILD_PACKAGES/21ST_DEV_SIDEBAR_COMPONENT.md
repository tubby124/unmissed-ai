# 21st.dev Sidebar Component — Saved from User's Claude Code Session

> Integration prompt for shadcn sidebar primitive with all dependencies.
> Saved: 2026-03-23
...
### Hook: use-mobile.tsx
Save to: `src/components/hooks/use-mobile.tsx`
