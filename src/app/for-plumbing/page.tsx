      ...
      <main style={{ backgroundColor: "#0A0A0A" }}>
        ...
        >
          <div className="max-w-4xl mx-auto grid grid-cols-3 gap-6 text-center">
            <div>
              <p className="text-3xl font-black mb-1" style={{ color: "#3B82F6" }}>$200&ndash;$600</p>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold">Dave P.</p>
                  <p className="text-gray-500 text-sm">Plumbing company owner &middot; Calgary, AB</p>
                </div>
              </div>
            </div>
          </div>
