      ...
      <main style={{ backgroundColor: "#0A0A0A" }}>
        ...
        >
          <div className="max-w-4xl mx-auto grid grid-cols-3 gap-6 text-center">
            <div>
              <p className="text-3xl font-black mb-1" style={{ color: "#3B82F6" }}>$800&ndash;$2,000</p>
              <p className="text-gray-500 text-sm">Avg new patient lifetime value</p>
            </div>
            <div>
              <p className="text-3xl font-black mb-1" style={{ color: "#EF4444" }}>8+ calls/week</p>
              <p className="text-gray-500 text-sm">Missed outside office hours</p>
            </div>
            <div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold">Dr. Ashley K.</p>
                  <p className="text-gray-500 text-sm">Family Dental &middot; Saskatoon, SK</p>
                </div>
              </div>
            </div>
          </div>
