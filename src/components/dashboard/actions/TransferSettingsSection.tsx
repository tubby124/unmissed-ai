      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <textarea
            ...
            disabled={previewMode}
            className="w-full bg-hover border b-theme rounded-lg px-3 py-2 text-sm t1 placeholder:t3 focus:outline-none focus:border-white/20 resize-none disabled:opacity-50"
          />
