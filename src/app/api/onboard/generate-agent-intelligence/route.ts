...
The agent's opening line when answering the phone. Must:
- Name the business
- Signal 2-3 specific capabilities (what the agent CAN DO for the caller)
- End with an open question
- Sound natural and confident, not robotic
Format: "${body.businessName} — ${agentName} here, AI assistant. [capability signal] — [open question]?"
