        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link href="/try" className="text-sm t2 hover:t1 transition-colors">Try the Agent</Link>
              <Link href="/for-auto-glass" className="text-sm t2 hover:t1 transition-colors">Auto Glass</Link>
              <Link href="/pricing" className="text-sm t2 hover:t1 transition-colors">Pricing</Link>
              <Link href="/about" className="text-sm t2 hover:t1 transition-colors">About</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link href="/keep-your-number" className="text-sm t2 hover:t1 transition-colors">Keep Your Number</Link>
              <Link href="/guardrails" className="text-sm t2 hover:t1 transition-colors">Guardrails</Link>
              <a href={`mailto:${HELLO_EMAIL}`} className="text-sm t2 hover:t1 transition-colors">Email Hasan</a>
            </div>
          </div>
        </div>
