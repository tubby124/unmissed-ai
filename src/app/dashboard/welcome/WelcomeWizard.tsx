    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold t1 mb-1">Welcome to End Voicemail</h1>
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="rounded-xl border b-theme bg-hover px-3 py-3 space-y-2">
                <p className="text-[11px] font-semibold t1">Test the real path on Go Live</p>
                <p className="text-[10px] t3 leading-snug">
                  The reliable test is manual: call your normal business number from another phone, let it miss, then confirm the agent answers and the call summary appears.
                </p>
              </div>

              <p className="text-[10px] t3">You can continue to Go Live for the final forwarding checklist and summary proof.</p>
            </div>
          )}
