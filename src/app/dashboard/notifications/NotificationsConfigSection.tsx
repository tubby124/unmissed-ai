...
const SELECT = 'id, telegram_chat_id, telegram_bot_token, telegram_style, weekly_digest_enabled, contact_email, telegram_notifications_enabled, email_notifications_enabled, alert_phone, alert_email, alert_email_cc, sms_alerts_enabled, notification_filter_spam, callback_phone, twilio_number, telegram_registration_token'
